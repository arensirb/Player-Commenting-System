...
public class Settings {
	...
	public static String mysqlTable = "prikkdata";
	...
	private static void loadPropertiesFiles(File dataFolder) {
	    ...
	    PropertiesFile pf = new PropertiesFile(new File(dataFolder, "PrikkSystem.properties"));
        ...
        mysqlTable = pf.getString("mysqlTable", "prikkdata", "What table name to use in DB");
